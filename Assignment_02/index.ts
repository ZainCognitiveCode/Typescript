...
var Temperature_in_C:number = 17;
var To_Farenheit:number = (Temperature_in_C* 9/5) +32;
...
var output:number = (num1/total)*100
...
var original_price:number = 120;


if(price || original_price>=100){
     var discount:number = original_price*0.1;
     var discountedPrice:number = original_price - discount;
    ...
    var discount:number = original_price*0.05;
    var discountedPrice:number = original_price - discount;
    console.log(`Original Price: $${original_price.toFixed(2)}`);
...
var consumedUnit:number = 430;
var unitprice:number = 20;
var billAmount:number = consumedUnit*unitprice;
